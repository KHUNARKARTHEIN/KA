...
.file-view-item .file-title a, .file-view-item .file-title {
	color:#fff !important;
}
...
.ossn-profile-module-friends {
    text-align: center;
}
/************************************
	Layouts
************************************/
/** didn't we have a minimum page height in goblack? #702 **/
.ossn-layout-module,
...
.ossn-wall-item .post-contents p {
   /** Incorrect Hyphenation in the theme goblack 3.0 #824 **/
