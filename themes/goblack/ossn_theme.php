 ...
 */
define('__THEMEDIR__', ossn_route()->themes . 'goblack/');

ossn_register_callback('ossn', 'init', 'ossn_goblack_theme_init');

function ossn_goblack_theme_init(){	
	//add bootstrap
	...
	ossn_extend_view('ossn/admin/head', 'ossn_goblack_admin_head');
	ossn_extend_view('ossn/site/head', 'ossn_goblack_head');
    ossn_extend_view('js/opensource.socialnetwork', 'js/goblack');	
}
function ossn_goblack_head(){
	$head	 = array();
...
function ossn_goblack_admin_head(){
	$head	 = array();	
	$head[]  = ossn_html_css(array(
					'href' => '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css'
			  ));	
